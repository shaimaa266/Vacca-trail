...
import 'package:app_vacca/features/doctor%20view/presentation/view/features/activity%20place/edit%20place.dart';
...
class ViewPlace extends StatefulWidget {
  ...
  @override
  State<ViewPlace> createState() => _ViewSystemState();
}

class _ViewSystemState extends State<ViewPlace> {
      ...
      body: BackGreoundImageContainer(
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                const MyTitle(text: /*nameSysController.text,*/ " System Name "),
                SizedBox(
                  height: 10.h,
                ),
                Container(
