...
import 'package:app_vacca/features/doctor%20view/presentation/view/features/breeding%20system/edit%20system/edit%20system.dart';
...
class ViewBreedSystem extends StatefulWidget {
  ViewBreedSystem({super.key});

  @override
  State<ViewBreedSystem> createState() => _ViewSystemState();
}

class _ViewSystemState extends State<ViewBreedSystem> {
  final dynamic editSystemRoute = EditBreedSystem();
